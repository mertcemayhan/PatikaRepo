...
public class SimpleCalculatorWithMethods {
    ...
    static void rectangularAreaAndPerimeter() {
        ...
        int short_ = scan.nextShort();
        System.out.print("Uzun kenarın uzunluğunu giriniz: ");
        int long_ = scan.nextInt();

        int area = short_ * long_;
        int perimeter = 2 * (short_ + long_);
        System.out.println("Dikdörtgenin çevresi: " + perimeter + ", alanı: " + area);
    }
